...
<div class="header">
	<div class="header-list">
	   <ul>
		  ...
		  <li><a href="tambah_petugas.php">DATA PETUGAS</a></li>
	   </ul>
    </div>
</div>	
<div class="container">
...
<br>
<div class="databes">
<table border="1" cellpadding="5" cellspacing="0" bgcolor='#D3D3D3'>
	    ...
	    <?php
	        ...
	        ?>
	          <?php if(ISSET($_POST['submit'])){
	          	...
	          	$cari = $_POST['nt'];
	          	$query2 = "SELECT * FROM petugas WHERE id_petugas LIKE '$_POST[nt]%' OR username LIKE '$_POST[nt]%' OR password LIKE '$_POST[nt]%' OR nama_petugas LIKE '$_POST[nt]%' OR level LIKE '$_POST[nt]%'";
